<?php
        ...
        $query = "INSERT INTO receitas (ID_Receita, nome_receita, modo_de_preparo, avaliacao, tempo_de_preparo, caminho_imagem, ID_Usuario, ingredientes) VALUES 
            ('$max_id', '$nome_receita', '$modo_de_preparo', '$avaliacao', '$tempo_de_preparo', '$caminho_imagem', '$id_usuario', '$ingredientes');";
